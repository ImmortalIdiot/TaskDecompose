...
internal class TaskRepositoryImpl(
    ...
    override suspend fun decomposeTask(
        ...
        val result = decomposeTaskWithRetry(prompt = prompt)
            .also { result ->
    ...
    private suspend fun decomposeTaskWithRetry(prompt: String) = retryOnDecompositionError {
        llmRouter.decomposeTask(prompt)
    }
